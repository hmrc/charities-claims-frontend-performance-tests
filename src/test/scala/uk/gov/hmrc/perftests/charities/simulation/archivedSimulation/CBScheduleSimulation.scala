...
import uk.gov.hmrc.perftests.charities.requests.CBScheduleUploadRequests.{loginToAuthWizard, _}
...
trait CBScheduleSimulation extends PerformanceTestRunner with BaseRequests {
